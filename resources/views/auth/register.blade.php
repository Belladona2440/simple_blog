              ...
              <div class="row gy-3 overflow-hidden">
                ...
                <div class="col-12">
                  <div class="form-floating border border-dark rounded mb-3">
                    <input type="text" class="form-control" name="name" id="name" placeholder="Choi Kupal" required>
                    <label for="name">Name</label>
                  </div>
                </div>
                <div class="col-12">
                  <div class="form-floating border border-dark rounded mb-3">
                    <input type="email" class="form-control" name="email" id="email" placeholder="choi@kupal.com" required>
